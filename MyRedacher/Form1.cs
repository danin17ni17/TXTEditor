    ...
    public partial class Form1 : Form
    {
        ...
        private void OpenDocument()
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show("Ошибка чтения файла.\n" + exc.ToString(), "MyRedacher", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private int SaveDocument()
        {
            ...
            if (fn != string.Empty)
            {
                ...
                {
                    MessageBox.Show(exc.ToString(), "MyRedacher", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            return result;
        }
        ...
        private void FileCreateToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult dr;
                dr = MessageBox.Show("Сохранить изменения ?", "MyRedacher", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning);
                switch (dr)
                {
